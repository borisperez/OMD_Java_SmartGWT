...
public class LogDS extends DataSource {

    public LogDS(String type) {
        ...
        if ("LogScreen".equals(type)) {
            ...
            setFields(logIdField, toolsField, processField, calledField, analystField, environmentNameField, environmentTypeField,  msgCodeField, envIdField,dateField,timeField,dateLoadField,statusField,whoIsField,msgField,resolutionField);
        }
        setClientOnly(true);
